...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-border py-20 bg-muted/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h3 className="text-xl font-medium">Al Amin</h3>
            </div>
            <p className="text-muted-foreground leading-relaxed max-w-lg mb-8">
              A passionate frontend developer crafting digital experiences with modern technologies. 
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="group p-3 border border-border rounded-lg hover:bg-accent/30 hover:border-accent transition-all duration-300"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-medium mb-6 uppercase tracking-wide text-muted-foreground">
              Quick Links
            </h4>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted-foreground">
              © {currentYear} Al Amin. All rights reserved.
            </p>
